...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Namhyuck (James) Kim"
    user-mail-address "namhyuck.james@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/skagur/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/skagur/bin" "/profile/bin" "/Users/skagur/.npm-packages/bin" "/Users/skagur/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
